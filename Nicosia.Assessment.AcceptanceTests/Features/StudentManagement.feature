Feature: Student Management
    ...
    Scenario: Create Read Edit Delete Student
        When user login with following details
        | username                      | password |
        | Gunther.central.perk@mail.com | P@s$w0rD |
        Then system must respond with code of "200"
		...
		Then system must respond with code of "400"
        ...
        Then system must respond with code of "400" 
        And system response contains "duplicate by email addres"
    ...
    Scenario: Email Validation Criteria in the system
        When user login with following details
        | username                      | password |
        | Gunther.central.perk@mail.com | P@s$w0rD |
        Then system must respond with code of "200"
