...
{
    public class AddNewSectionCommandValidator : AbstractValidator<AddNewSectionCommand>
    {
        ...
        public AddNewSectionCommandValidator(ISectionContext sectionContext, IPeriodContext periodContext, ICourseContext courseContext)
        {
